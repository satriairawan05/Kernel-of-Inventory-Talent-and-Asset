...
<div class="container-fluid py-4 page-shell">
    <section class="page-hero d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3">
        ...
        <span class="badge bg-white text-primary fs-6 px-3 py-2"><i class="fas fa-pen me-1"></i> Edit transaksi</span>
    </section>
            ...
            <form action="{{ route('inventory.stock-in.update', $stockIn) }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" step="0.01" id="qty" name="qty" value="{{ old('qty', $stockIn->qty) }}" class="form-control @error('qty') is-invalid @enderror" placeholder="0.00">
                ...
                <div class="d-flex justify-content-end gap-2 action-bar">
                    ...
                    <button type="submit" class="btn btn-primary"><i class="fas fa-save me-1"></i> Update Barang Masuk</button>
                </div>
            </form>
        </div>
    </div>
