...
<div class="container-fluid py-4 page-shell">
    ...
    <div class="card soft-card mt-4">
        ...
        <div class="card-body">
            <form action="{{ route('inventory.product.update', $product) }}" method="POST" enctype="multipart/form-data" class="row g-3">
                @csrf
                @method('PUT')
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="product_name" placeholder="Ayam Kecil" value="{{ old('product_name', $product->product_name) }}" class="form-control @error('product_name') is-invalid @enderror" required>
                    @error('product_name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                
                <div class="col-md-6">
                    <label class="form-label">Product Code</label>
                    <input type="text" name="product_code" placeholder="AK-001" value="{{ old('product_code', $product->product_code) }}" class="form-control @error('product_code') is-invalid @enderror" required>
