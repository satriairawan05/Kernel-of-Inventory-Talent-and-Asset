...
@push('css')
    <style>
        ...
        .soft-panel .table tbody tr:hover {
            background: #f8fbff;
        }
        ...
        <section class="page-hero d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3">
            ...
            <div class="d-flex flex-wrap gap-2 align-items-center search-shell">
                <form method="GET" action="{{ route('inventory.product.index') }}"
                    ...
                    <button class="btn btn-light text-primary" type="submit"><i class="fas fa-search me-1"></i>
                        Cari</button>
                    @if ($search)
                ...
                @if ($access['Create'] == 1)
                    <a href="{{ route('inventory.product.create') }}" class="btn btn-success"><i
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <div class="d-flex justify-content-end gap-2">
                                                ...
                                                @if ($access['Update'] == 1)
                                                    <a href="{{ route('inventory.product.edit', $product) }}"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content border-0 shadow">
                                                        ...
                                                        <div class="modal-body text-center py-4">
                                                            <p class="mb-0">Yakin ingin menghapus
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form
                                                                action="{{ route('inventory.product.destroy', $product) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit"
