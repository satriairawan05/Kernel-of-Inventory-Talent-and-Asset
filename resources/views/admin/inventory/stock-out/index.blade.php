...
<div class="container-fluid py-4 page-shell">
    <section class="page-hero d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3">
        ...
        <a href="{{ route('inventory.stock-out.create') }}" class="btn btn-success"><i class="fas fa-plus me-1"></i> Tambah Barang Keluar</a>
    </section>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="{{ route('inventory.stock-out.edit', $item) }}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content border-0 shadow">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('inventory.stock-out.destroy', $item) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
