    ...
    <div class="container-fluid py-4 page-shell">
        <section class="page-hero d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3">
            <div>
                ...
                <h2 class="mb-1">Edit Stock Out</h2>
            </div>
        ...
        <div class="card soft-card mt-4">
            <div class="card-header">
                <h4 class="mb-1">Edit Stock Out Form</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('inventory.stock-out.update', $stockOut) }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <small class="text-muted">Current stock:
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="notes" name="notes" rows="3" class="form-control @error('notes') is-invalid @enderror"
                            placeholder="Additional notes...">{{ old('notes', $stockOut->notes) }}</textarea>
                        @error('notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-12">
                        <div class="alert alert-info">
                            <small>
                                ...
                                This transaction was created by <strong>{{ $stockOut->user->name ?? '-' }}</strong>
                                on {{ $stockOut->created_at->format('d/m/Y H:i') }}
                            </small>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2 action-bar">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="fas fa-save me-1"></i> Update Stock Out</button>
                    </div>
                </form>
            </div>
        </div>
