...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <a href="{{ route('inventory.category.create') }}" class="btn btn-success btn-add-company">
                        ...
                        @forelse($categories as $category)
                            <tr>
                                ...
                                <td class="action-buttons d-md-flex flex-md-row align-items-md-center gap-2">
                                    <a href="{{ route('inventory.category.edit', $category) }}" class="btn btn-sm btn-primary">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content border-0 shadow">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{ route('inventory.category.destroy', $category) }}"
                                                        method="POST">
