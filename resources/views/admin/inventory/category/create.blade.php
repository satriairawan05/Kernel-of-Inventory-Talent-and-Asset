...
<div class="container-fluid py-4 page-shell">
    <section class="page-hero d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3">
        ...
        <span class="badge bg-white text-primary fs-6 px-3 py-2"><i class="fas fa-tags me-1"></i> New category</span>
    </section>
            ...
            <form action="{{ route('inventory.category.store') }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-8 mb-3">
                        ...
                        <input type="text" id="category_name" name="category_name" value="{{ old('category_name') }}" class="form-control @error('category_name') is-invalid @enderror" placeholder="Example: Electronics, Furniture, etc.">
                        @error('category_name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                </div>
                <div class="mb-4">
                    <label class="form-label" for="description">Description</label>
                    <textarea id="description" name="description" rows="4" class="form-control @error('description') is-invalid @enderror" placeholder="Example: Category for IT equipment and assets.">{{ old('description') }}</textarea>
