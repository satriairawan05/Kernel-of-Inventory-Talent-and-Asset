...
<div class="container-fluid py-4 page-shell">
    <section class="page-hero d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3">
        <div>
            ...
            <h2 class="mb-1">Edit Return Barang</h2>
        </div>
        <span class="badge bg-white text-primary fs-6 px-3 py-2"><i class="fas fa-edit me-1"></i> Edit Return</span>
    </section>

    <div class="card soft-card mt-4">
        <div class="card-header">
            <h4 class="mb-1">Form Edit Return</h4>
        </div>
        <div class="card-body">
            <form action="{{ route('inventory.return-stock.update', $return) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row g-3">
