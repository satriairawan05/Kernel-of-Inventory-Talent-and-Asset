...
<div class="container-fluid py-4 page-shell">
    <section class="page-hero d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3">
        <div>
            ...
            <h2 class="mb-1">Add New Stock</h2>
        </div>
        <span class="badge bg-white text-primary fs-6 px-3 py-2"><i class="fas fa-boxes me-1"></i> New stock entry</span>
    </section>
            ...
            <form action="{{ route('inventory.stock.store') }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" step="0.01" id="current_stock" name="current_stock" value="{{ old('current_stock', 0) }}" class="form-control @error('current_stock') is-invalid @enderror" placeholder="0.00">
