        ...
        <div class="card-body">
            ...
            <form action="{{ route('setting.shift.update', $shift) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select
                        ...
                        @foreach ($companies as $company)
                            <option
                                value="{{ $company->id }}"
                                @selected(old('company_id', $shift->company_id) == $company->id)>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input
                            ...
                            value="{{ old('early_leave_tolerance_minutes', $shift->early_leave_tolerance_minutes) }}"
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <a
                        href="{{ route('setting.shift.index') }}"
