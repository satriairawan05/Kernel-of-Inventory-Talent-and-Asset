                                                ...
                                                <div class="modal-content border-0 shadow">
                                                    <div class="modal-header bg-danger">
                                                        <h5 class="modal-title text-white"
                                                            id="deleteShiftModalLabel{{ $shift->id }}"><i
                                                                class="fas fa-triangle-exclamation me-2"></i> Delete Shift
                                                        </h5><button class="btn p-1" type="button" data-bs-dismiss="modal"
                                                            aria-label="Close"><i
                                                    ...
                                                    <div class="modal-body text-center py-4">
                                                        ...
                                                        <p class="text-danger small mt-2 mb-0">This action cannot be undone.
                                                        </p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="{{ route('setting.shift.destroy', $shift) }}"
                                                            ...
                                                            <button type="submit" class="btn btn-danger"><i
                                                                    class="fas fa-trash me-2"></i> Delete Shift</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
