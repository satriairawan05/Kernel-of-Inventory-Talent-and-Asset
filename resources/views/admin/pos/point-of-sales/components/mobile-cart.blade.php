...
<button class="mobile-cart-toggle" id="mobileCartToggle" x-show="$store.pos.showMobileCart" @click="$store.pos.toggleMobileCart()" style="display:none;">
    <i class="bi bi-cart3"></i> Cart
    <span class="badge" x-text="$store.pos.cartCount">0</span>
</button>
<div class="cart-sidebar d-lg-none" id="mobileCartSidebar" :class="{ 'open': $store.pos.mobileCartOpen }" x-data="mobileCartComponent">
    ...
    <div class="opening-balance">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <span>
                ...
                <button class="btn btn-sm btn-link p-0 ms-1" @click="$store.pos.openEditOpeningBalance()" title="Edit Opening Balance">
        ...
        <template x-for="item in $store.pos.cart" :key="item.id">
            <div class="cart-item">
                ...
                <span>
                    ...
                    <button class="remove-btn" @click="$store.pos.removeFromCart(item.id)"><i class="bi bi-dash-circle"></i></button>
                    <button class="clear-btn" x-show="item.qty > 2" @click="$store.pos.resetTo(item.id, 2)" title="Reset to 2">
    ...
    <button class="btn-checkout" :disabled="$store.pos.cartCount === 0" @click="$store.pos.openCheckout()">Checkout <i class="bi bi-arrow-right"></i></button>
    ...
    <button class="btn-add-manual" @click="$store.pos.openAddMenu()"><i class="bi bi-plus-circle me-1"></i> Add Manual Menu</button>
</div>