<div class="col-lg-4 d-none d-lg-block" x-data="cartSidebarComponent">
    <div class="cart-sidebar" id="cartSidebar">
        ...
        <button class="btn-checkout" :disabled="$store.pos.cartCount === 0" @click="$store.pos.openCheckout()">
        ...
        {{-- <button class="btn-add-manual" @click="$store.pos.openAddMenu()">
            <i class="bi bi-plus-circle me-1"></i> Add Manual Menu
        </button> --}}
    </div>
</div>