            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    <div class="summary-stats">
                        ...
                        <h3>{{ \Carbon\Carbon::rupiah($reports->total() > 0 ? $reports->sum('total_amount') / $reports->total() : 0, 0, ',', '.') }}
                        </h3>
                    </div>
                </div>
            </div>
                            ...
                            @forelse($reports as $report)
                                <tr>
                                    <td class="text-center"><span
                                            class="badge bg-secondary rounded-pill">{{ $reports->firstItem() + $loop->index }}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-end"><span
                                            class="amount-text text-success">{{ \Carbon\Carbon::rupiah($report->accessories_amount ?? 0, 0, ',', '.') }}</span>
                                    </td>
                                    <td class="text-end"><span
                                            class="amount-text text-info">{{ \Carbon\Carbon::rupiah($report->service_amount ?? 0, 0, ',', '.') }}</span>
                                    </td>
                                    <td class="text-end"><span
                                            class="amount-text text-warning">{{ \Carbon\Carbon::rupiah($report->pulsa_amount ?? 0, 0, ',', '.') }}</span>
                                    </td>
                                    <td class="text-end"><strong
                                            class="amount-text text-primary">{{ \Carbon\Carbon::rupiah($report->total_amount ?? 0, 0, ',', '.') }}</strong>
                                    </td>
                                    <td class="text-center">
                                        <div class="action-buttons justify-content-center">
                                            <a href="{{ route('pos.report.show', $report) }}"
                                                class="btn btn-sm btn-subtle-primary">
                                                <i class="fas fa-eye"></i> Detail
                                            </a>
                                            @if ($access['Update'] == 1)
                                                <a href="{{ route('pos.report.edit', $report) }}"
                                                    ...
                                                    <div class="modal-content border-0 shadow">
                                                        <div class="modal-header bg-danger">
                                                            <h5 class="modal-title text-white"
                                                                ...
                                                                <i class="fas fa-triangle-exclamation me-2"></i> Delete
                                                                Report
                                                            </h5>
