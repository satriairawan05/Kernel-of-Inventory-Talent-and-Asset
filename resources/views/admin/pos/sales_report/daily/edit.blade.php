    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h4 class="mb-0">
                    <i class="fas fa-edit"></i> Edit Sales Report
                </h4>
        ...
        <div class="card-body">
            <form action="{{ route('pos.report.update', $report) }}" method="POST">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" id="pulsa_amount" name="pulsa_amount" 
                                    value="{{ old('pulsa_amount', $report->pulsa_amount ?? 0) }}"
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" id="accessories_amount" name="accessories_amount" 
                                    value="{{ old('accessories_amount', $report->accessories_amount ?? 0) }}"
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" id="service_amount" name="service_amount" 
                                    value="{{ old('service_amount', $report->service_amount ?? 0) }}"
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    @if(isset($report->id))
                    <a href="{{ route('pos.report.show', $report->id) }}" class="btn btn-info">
