    ...
    <main class="main" id="top">
                ...
                <div class="navbar-logo">
                    ...
                    <a class="navbar-brand me-1 me-sm-3" href="{{ route('home') }}">
                        <div class="d-flex align-items-center">
                            <div class="d-flex align-items-center"><img src="{{ asset('assets/img/icons/av color.png') }}"
                                    alt="phoenix" width="27" />
                                <h5 class="logo-text ms-2 d-none d-sm-block">{{ env('APP_NAME') }}</h5>
                            </div>
                        </div>
                    </a>
                </div>
                                    ...
                                    <div class="row gx-4 gy-5">
                                        ...
                                        <div class="col-12 col-sm-6 col-md-4">
                                            <div class="dropdown-item-group"><span class="me-2"
                                                ...
                                                class="dropdown-link"
                                                href="../modules/components/dhtmlx-gantt.html">Dhtmlx gantt</a><a
                                                class="dropdown-link"
                        ...
                        <div class="card position-relative border-0">
                            ...
                            <div class="card-footer p-0 border-top border-translucent border-0">
                                <div class="my-2 text-center fw-bold fs-10 text-body-tertiary text-opactity-85"><a
                                        class="fw-bolder" href="notifications.html">Notification history</a></div>
                            </div>
                        </div>
                    </div>
                </li>
        ...
        <nav class="navbar navbar-top navbar-slim justify-content-between fixed-top navbar-expand-lg"
            ...
            <div class="navbar-logo">
                ...
                <a class="navbar-brand navbar-brand" href="#">phoenix <span
                                ...
                                <div class="card position-relative border-0">
                                    ...
                                    <div class="card-footer p-0 border-top border-translucent border-0">
                                        <div
                                            ...
                                            <a class="fw-bolder" href="notifications.html">Notification history</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="authentication"
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown"><a class="dropdown-item dropdown-toggle"
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item"
                                                        href="authentication/card/sign-in.html">
                                                        <div class="dropdown-item-wrapper"><span
                                                                class="me-2 uil"></span>Sign in</div>
                                                    </a></li>
                                                <li><a class="dropdown-item"
                                                        href="authentication/card/sign-up.html">
                                                        <div class="dropdown-item-wrapper"><span
                                                                class="me-2 uil"></span>Sign up</div>
                                                    </a></li>
                                                <li><a class="dropdown-item"
                                                        href="authentication/card/sign-out.html">
                                                        <div class="dropdown-item-wrapper"><span
                                                                class="me-2 uil"></span>Sign out</div>
                                                    </a></li>
                                                <li><a class="dropdown-item"
